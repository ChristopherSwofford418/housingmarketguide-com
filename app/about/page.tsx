...
export const metadata: Metadata = {
  title: "About HousingMarketTracker",
  description: "About HousingMarketTracker — City-by-City Housing Market Data",
};
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 prose-article">
      <h1 className="text-3xl font-bold text-ink mb-6">About HousingMarketTracker</h1>
      <p>Free housing market data tracker. Compare home prices, inventory, and market trends across 200+ US cities. Updated monthly with the latest real estate data.</p>
      ...
      <h2>Contact</h2>
      <p>Questions or feedback? Reach us at: info@housingmarketguide.com</p>
    </div>
  );
}
